<?php
/* $Id: sql_mysql.php 2740 2009-02-03 10:51:46Z vadim $ */
...
/*
Anton back up query (trace query)	
        $filename = "/tmp/test_anton.log";
        ...
        if (true) {
            ...
            if (fwrite($handle, $query."/n") === FALSE) {
...
//        			echo $query."<br>";
*/
#		echo $this->num_queries." - ".$query."<br><br>";
