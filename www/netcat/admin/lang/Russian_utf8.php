...
define("CONTROL_CONTENT_SUBDIVISION_SUBCLASS_ERROR_KEYWORD_INVALID", "Ключевое слово содержит недопустимые символы, либо слишком длинное. Оно может содержать только буквы, цифры и дефис, и не может быть длиннее 64 символов.");
...
define("TOOLS_DATA_BACKUP_INCOMPATIBLE_VERSION",       "Данная версия файла-импорта не поддерживается системой!");
