var lg = {
	"AUTHORIZATION_REQUIRED": "No estГ s autoritzat a fer ser servir l'administrador d'arxius.",
	"INVALID_ACTION": "AcciГі invГ lida.",
	...
	"INVALID_VAR": "Variable %s invГ lida.",
	...
	"INVALID_DIRECTORY_OR_FILE": "Carpeta o arxiu invГ lid.",
	"INVALID_FILE_UPLOAD": "Transferencia d'arxiu invГ lida.",
	"UPLOAD_FILES_SMALLER_THAN": "Si us plau, Pugeu nomГ©s arxius amb tamany inferior a В %s.",
	"UPLOAD_IMAGES_ONLY": "Si us plau, pugeu nomГ©s imatges, els altres tipus d'arxius no estan permesos.",
	"UPLOAD_IMAGES_TYPE_JPEG_GIF_PNG": "Si us plau, pugeu nomГ©s arxius de tipus JPEG, GIF o PNG.",
	...
	"no_foldername": "No s'ha introduГЇt el nom de la carpeta.",
	"create_folder": "Crear una carpeta",
	"cancel": "CancelВ·lar",
	"select_from_left": "Selecciona un element de l'esquerra.",
	"fck_select_integration": "La funciГі 'Seleccionar' nomГ©s es far servir des de FCKEditor.",
	"new_filename": "Introdueix un nou nom per l'arxiu",
	"successful_rename": "Canvi de nom amb ГЁxit.",
	"rename": "Canviar el nom",
	"confirmation_delete": "EstГ s segur de voler eliminar aquest arxiu?",
	"successful_delete": "EliminaciГі amb ГЁxit.",
	"successful_added_file": "Nou arxiu afegit satisfactГІriament.",
	"successful_added_folder": "Nova carpeta afegida satisfactГІriament.",
	"select": "Seleccionar",
