        ...
        switch ($fldType[$i]) {
            ...
            case 8: // DateTime
                ...
                if ($format['type'] != 'event_time') {
                    $result .= "<input type='text' class='no_special_style' name='srchPat[" . $j . "]' size='2' maxlength='2' value='" . ($srchPat[$j] ? sprintf("%02d", $srchPat[$j]) : "") . "' placeholder='" . NETCAT_HINT_FIELD_D . "' >.";
                    $j++;
                    $result .= "<input type='text' class='no_special_style' name='srchPat[" . $j . "]' size='2' maxlength='2' value='" . ($srchPat[$j] ? sprintf("%02d", $srchPat[$j]) : "") . "' placeholder='" . NETCAT_HINT_FIELD_M . "' >.";
                    $j++;
                    $result .= "<input type='text' class='no_special_style' name='srchPat[" . $j . "]' size='4' maxlength='4' value='" . ($srchPat[$j] ? sprintf("%04d", $srchPat[$j]) : "") . "' placeholder='" . NETCAT_HINT_FIELD_Y . "' > ";
                    $j++;
                }
                else {
                    $j += 3;
                ...
                if ($format['type'] != 'event_date') {
                    $result .= "<input type='text' class='no_special_style' name='srchPat[" . $j . "]' size='2' maxlength='2' value='" . ($srchPat[$j] ? sprintf("%02d", $srchPat[$j]) : "") . "' placeholder='" . NETCAT_HINT_FIELD_H . "' >:";
                    $j++;
                    $result .= "<input type='text' class='no_special_style' name='srchPat[" . $j . "]' size='2' maxlength='2' value='" . ($srchPat[$j] ? sprintf("%02d", $srchPat[$j]) : "") . "' placeholder='" . NETCAT_HINT_FIELD_MIN . "' >:";
                    $j++;
                    $result .= "<input type='text' class='no_special_style' name='srchPat[" . $j . "]' size='2' maxlength='2' value='" . ($srchPat[$j] ? sprintf("%02d", $srchPat[$j]) : "") . "' placeholder='" . NETCAT_HINT_FIELD_S . "' > ";
                    $j++;
                }
                else {
                    $j += 3;
