...
$strMyISAMDataPointerSizeDesc = 'The default pointer size in bytes, to be used by CREATE TABLE for MyISAM tables when no MAX_ROWed = 'Pages to be flushed';  //to translate
...
$strShowStatusBinlog_cache_useDescr = 'The number of transactions that used the temporary binary log cache.'; S option is specified.';  //to translate
...
$strPagesToBeFlush //to translate
