...
$day_of_week = array('Du', 'Lu', 'Ma', 'Mi', 'Jo', 'Vi', 'Sо');
...
$strAbortedClients = 'Оntrerupt';
$strAccessDenied = 'Acces interzis';
$strAccessDeniedExplanation = 'phpMyAdmin a оncercat sa se conecteze la serverul MySQL, dar acesta a respins conexiunea. Ar trebui verificat daca datele din config.inc.php sоnt corecte.';
$strAction = 'Actiune';
$strAddAutoIncrement = 'Adauga valoare pentru AUTO_INCREMENT';
$strAddClause = 'Adaugare %s';
$strAddConstraints = 'Adauga constrоngere';
$strAddDeleteColumn = 'Adauga/sterge coloane';
$strAddDeleteRow = 'Adauga/sterge criteriu';
$strAddFields = 'Adauga %s cоmp(uri)';
$strAddHeaderComment = 'Adaugare comentariu la antet (\\n оnseamna delimitare de rоnd)';
$strAddIntoComments = 'Adaugare la comentarii';
$strAddNewField = 'Adauga cоmp nou';
...
$strAfterInsertNewInsert = 'Adauga o noua оnregistrare';
$strAfterInsertNext = 'Editeaza rоndul urmator';
$strAfterInsertSame = 'Оnapoi la aceasta pagina';
...
$strAtBeginningOfTable = 'La оnceputul tabelului';
$strAtEndOfTable = 'La sfоrsitul tabelului';
$strAttr = 'Proprietati';
$strAutomaticLayout = 'Asezare automata';

$strBack = 'Оnapoi';
$strBaltic = 'Baltic';
$strBeginCut = 'DE TAIAT - ОNCEPUT';
$strBeginRaw = 'ОNCEPUT RAW';
$strBinary = 'Binar';
...
$strCantUseRecodeIconv = 'Nu pot folosi functiile iconv nici libiconv nici recode_string оn timp ce extensia este incarcata. Verifica configuratia PHP.';
...
$strChangeCopyModeDeleteAndReload = ' ... sterge cel vechi din tabelul de utilizatori si reоncarca privilegiile.';
...
$strChangeDisplay = 'Selecteaza un cоmp';
...
$strCreateNewTable = 'Creeaza tabel nou оn baza de date %s';
...
$strCreationDates = 'Creare/reоnnoire/verificare date';
...
$strDatabaseEmpty = 'Cоmpul de denumire al bazei de date este gol!';
...
$strDatabasesStatsHeavyTraffic = 'Nota: Activarea statisticilor pentru baza de date poate cauza cresterea traficului оntre MySQL si serverul Web.';
...
$strDBRename = 'Redenumire baza de date оn';
...
$strDelayedInserts = 'Foloseste inserari оntоrziate';
$strDeleteAndFlushDescr = 'Este cea mai simpla metoda, dar reоncarcarea drepturilor s-ar putea sa dureze.';
$strDeleteAndFlush = 'Sterge utilizatorii si reоncarca drepturile pe urma.';
$strDeleted = 'Linia a fost stearsa';
$strDeletedRows = 'Rоnduri sterse:';
...
$strDrop = 'Arunca';
$strDropDatabaseStrongWarning = 'Sоnteti pe cale sa DISTRUGETI o оntreaga baza de date!';
$strDropUsersDb = 'Arunca baza de date care are acelasi nume ca utilizatorul.';
$strDumpingData = 'Salvarea datelor din tabel';
$strDumpSaved = 'Copia a fost salvata оn fisierul %s.';
$strDumpXRows = 'Arunca %s rоnduri, оncepоnd de la rоndul %s.';
$strDynamic = 'dinamic';
...
$strEnabled = 'Activat';
$strEncloseInTransaction = 'Cuprinde exportarea оntr-o tranzactie';
$strEndCut = 'DE TAIAT - SFОRSIT';
$strEndRaw = 'SFОRSIT BRUT';
$strEnd = 'Sfоrsit';
...
$strEnglish = 'Englez';
$strEnglishPrivileges = ' Important: numele drepturilor de acces MySQL apar оn engleza';
$strError = 'Eroare';
$strErrorInZipFile = 'Eroare оn arhiva ZIP:';
$strErrorRenamingTable = 'Eroare la redenumirea tabelului %1$s оn %2$s';
$strEscapeWildcards = 'Metacaracterele _ si % trebuiesc оnsotite de \ pentru a le aplica';
...
$strFailedAttempts = 'Оncercari nereusite';
$strField = 'Cоmp';
$strFieldHasBeenDropped = 'Cоmpul %s a fost aruncat';
$strFields = 'Cоmpuri';
$strFieldsEnclosedBy = 'Cоmpuri оncadrate de';
$strFieldsEscapedBy = 'Cоmpuri realizate de';
$strFieldsTerminatedBy = 'Cоmpuri terminate de';
...
$strFixed = 'fixat';
$strFlushPrivilegesNote = 'Nota: phpMyAdmin foloseste privilegiile utilizatorilor direct din tabelul de privilegii din MySQL. Continutul acestui tabel poate diferi de cel original. Оn acest caz, reоncarcati de aici оnainte de a continua %sreоncarcarea drepturilor%s.';
$strFlushQueryCache = 'Reinitializare cache interogare';
$strFlushTable = 'Curatarea tabelului ("FLUSH")';
$strFontSize = 'Dimensiune font';
$strFormat = 'Format';
$strFormEmpty = 'Valoarea lipseste оn formular !';
$strFreePages = 'Pagini libere';
$strFullText = 'Texte оntregi';
$strFunction = 'Functie';
...
$strIgnoreDuplicates = 'Ignora rоnduri duplicate';
$strIgnore = 'Ignora';
...
$strInsertedRowId = 'ID rоnd inserat:';
$strInsertedRows = 'rоnduri inserate:';
$strInsert = 'Inserare';
$strInternalNotNecessary = '* Nu se cere o relatie interna оn cazul оn care exista si оn InnoDB.';
$strInternalRelationAdded = 'Relatie interna adaugata';
$strInternalRelations = 'Relatii interne';
$strInUse = 'оn folosinta';
...
$strJustDeleteDescr = 'Utilizatorii &quot;stersi&quot; vor avea acces la server la fel ca pоna acum, pоna cоnd drepturile sоnt reоncarcate.';
...
$strLimitNumRows = 'Numarul de оnregistrari pe pagina';
...
$strMbOverloadWarning = 'Ati activat mbstring.func_overload оn configuratia PHP. Aceasta optiune nu este compatibila cu phpMyAdmin si poate duce la pierderea unor date!';
...
$strMIME_nodescription = 'Nu este disponibila nici o descriere pentru aceasta transformare.<br />Оntrebati autorul de functiile оndeplinite de %s.';
...
$strMIME_transformation_options_note = 'Introduceti valorile pentru optiunile de transformare utilizоnd acest format: \'a\', 100, b,\'c\'...<br />Daca trebuie sa folositi backslash ("\") sau apostrof  ("\'") in aceste valori, introduceti backslash-uri (ex. \'\\\\xyz\' sau \'a\\\'b\').';
...
$strMyISAMDataPointerSizeDesc = 'Marimea pointerului implicit (in octeti), care este folosit de CREATE TABLE pentru tabelele MyISAM atunci cоnd nu este specificata nici o optiune MAX_ROWS.';
$strMyISAMDataPointerSize = 'Marime pointer date';
$strMyISAMMaxExtraSortFileSizeDesc = 'Daca fisierul temporar utilizat pentru crearea rapida a indexului MyISAM ar fi mai mare decоt daca s-ar utiliza cache-ul de chei. Se prefera utilizarea metodei "cache chei".';
$strMyISAMMaxExtraSortFileSize = 'Marimea maxima pentru fisierele temporare la crearea indexului';
$strMyISAMMaxSortFileSizeDesc = 'Marimea maxima pentru fisierul temporar, permisa оn MySQL оn timpul recrearii unui index MyISAM (оn timpul operatiunilor REPAIR TABLE, ALTER TABLE, sau LOAD DATA INFILE).';
...
$strMyISAMRepairThreadsDesc = 'Daca aceasta valoare este mai mare decоt 1, indexurile de tabel MyISAM sоnt create оn paralel (fiecare index оn firul de executie propriu) оn tipul operatiunii de reparare prin procesul de sortare.';
$strMyISAMRepairThreads = 'Repara firele de executie';
$strMyISAMSortBufferSizeDesc = 'Tamponul alocat la sortarea indexurilor MyISAM оn timpul unei operatiuni REPAIR TABLE sau la crearea indexurilor cu CREATE INDEX sau ALTER TABLE.';
...
$strNoDatabases = 'Nu sоnt baze de date';
...
$strNoDropDatabases = 'Comenzile "DROP DATABASE" sоnt dezactivate.';
...
$strNoIndexPartsDefined = 'Nu sоnt definite parti din index!';
...
$strNoRowsSelected = 'Nu e nici un rоnd selectat';
$strNoSpace = 'Spatiu insuficient pentru salvarea fisierului %s.';
$strNoTablesFound = 'Nu s-a gasit nici un tabel оn baza de date.';
$strNoThemeSupport = 'Nu exista suport pentru tematici, va rugam sa verificati configuratia si/sau designurile оn directorul %s.';
$strNotNumber = 'Acesta nu este un numar!';
$strNotOK = 'Nu este bine';
$strNotSet = '<b>%s</b> tabelul nu a fost gasit sau nu este stabilit оn %s';
$strNoUsersFound = 'Nu s-a gasit nici un utilizator.';
$strNoValidateSQL = 'Sari peste validarea SQL';
$strNull = 'Nul';
$strNumberOfFields = 'Numar de cоmpuri';
$strNumberOfTables = 'Numar de tabele';
$strNumSearchResultsInTable = '%s rezultat(e) оn interiorul tabelului <i>%s</i>';
...
$strPmaUriError = 'Directiva <tt>$cfg[\'PmaAbsoluteUri\']</tt> TREBUIE sa fie stabilita оn fisierul de configurare!';
...
$strPrimary = 'Primar';
$strPrint = 'Listare';
$strPrintViewFull = 'Vizualizare listare (оmpreuna cu text)';
...
$strPrivDescInsert = 'Permite inserarea si оnlocuirea datelor.';
$strPrivDescLockTables = 'Permite blocarea tabelelor din firul curent de executie.';
$strPrivDescMaxConnections = 'Limiteaza numarul de noi conexiuni care pot fi deschise de utilizator оntr-o ora.';
$strPrivDescMaxQuestions = 'Limiteaza numarul de comenzi care pot fi trimise de utilizator catre server оntr-o ora.';
$strPrivDescMaxUpdates = 'Limiteaza numarul de comenzi pentru schimbarea vreunui tabel sau vreunei baze de date executabile de utilizator оntr-o ora.';
$strPrivDescProcess3 = 'Permite oprirea proceselor altor utilizatori.';
$strPrivDescProcess4 = 'Permite vizualizarea comenzilor procesate оn lista.';
$strPrivDescReferences = 'Nu are efect оn aceasta versiune MySQL.';
$strPrivDescReload = 'Permite reоncarcarea setarilor de server si golirea memoriei cache a serverului.';
...
$strPrivilegesReloaded = 'Drepturile au fost reоncarcate cu succes.';
$strProcedures = 'Proceduri';
$strProcesses = 'Procese';
$strProcesslist = 'Lista procese';
$strProtocolVersion = 'Versiune protocol';
$strPutColNames = 'Pune numele cоmpului оn primul rоnd';
...
$strQueryStatistics = '<b>Statistica interogari</b>: De la оnceput, s-au trimis %s interogari la server.';
...
$strReloadingThePrivileges = 'Reоncarcarea drepturilor';
$strReloadPrivileges = 'Reоncarcare privilegii';
$strReload = 'Reоncarca';
$strRemoveSelectedUsers = 'Eliminarea utilizatorilor selectati';
$strRenameDatabaseOK = 'Baza de date %s a fost redenumita оn %s';
$strRenameTableOK = 'Tabelului %s i s-a dat un numele de %s';
$strRenameTable = 'Redenumire tabel la';
$strRepairTable = 'Reparare tabel';
$strReplaceNULLBy = 'Оnlocuire NULL cu';
$strReplaceTable = 'Оnlocuieste datele tabelului cu fisier';
$strReset = 'Resetare';
$strResourceLimits = 'Limitare de resurse';
$strReType = 'Re-type';
$strRevokeAndDeleteDescr = 'Utilizatorii vor avea оn continuare drepturi de UTILIZARE pоna la reоncarcarea drepturilor.';
...
$strRowsFrom = 'linii оncepоnd cu';
$strRowSize = ' Marime linie ';
$strRows = 'Linie';
$strRowsModeFlippedHorizontal = 'orizontal (colontitlu rotativ)';
$strRowsModeHorizontal = 'orizontal';
$strRowsModeOptions = 'оn mod %s si repetare colontitlu dupa %s celule';
$strRowsModeVertical = 'vertical';
$strRowsStatistic = 'Statisticile rоndului';
$strRunning = 'rulоnd pe %s';
$strRunQuery = 'Trimite comanda';
$strRunSQLQuery = 'Executa interogare SQL asupra bazei de date %s';
$strRussian = 'Rus';

$strSaveOnServer = 'Salveaza pe server оn directorul %s';
$strSavePosition = 'Salveaza pozitie';
$strSave = 'Salveaza';
$strScaleFactorSmall = 'Factorul de scalare este prea mica pentru a inchepe in pagina';
$strSearch = 'Cauta';
$strSearchFormTitle = 'Cauta оn baza de date';
$strSearchInTables = 'Оn interiorul tabelei(lor):';
$strSearchNeedle = 'Cuvоnt/valoare de cautat (metacaracter: "%"):';
...
$strSelectFields = 'Selecteaza cоmpurile (cel putin unul):';
$strSelectForeignKey = 'Alegeti cheia straina';
$strSelectNumRows = 'оn interogarea';
...
$strServerTrafficNotes = '<b>Trafic server</b>: Aceste tabele arata statistica de trafic оn retea a acestui server MySQL de la lansare.';
$strServerVars = 'Variabile si configurari de server';
$strServerVersion = 'Versiune server';
$strSessionValue = 'Valoare sesiune';
$strSetEnumVal = 'Daca cоmpul este "enum" sau "set", va rugam sa adaugati valori folosind formatul: \'a\',\'b\',\'c\'...<br />Daca aveti nevoie sa puneti bara intoarsa (backslash) ("\") sau semnul ("\'") la aceste valori, folositi exemplul ( \'\\\\xyz\' or \'a\\\'b\').';
$strShow = 'Afiseaza';
$strShowAll = 'Arata toate';
$strShowColor = 'Arata culoarea';
$strShowDatadictAs = 'Data Dictionary Format';
$strShowFullQueries = 'Afisare comanda оntreaga';
$strShowGrid = 'Arata grila';
$strShowHideLeftMenu = 'Arata/ascunde meniul stоng';
$strShowingPhp = 'Afisare ca si cod PHP';
$strShowingRecords = 'Afiseaza оnregistrari';
...
$strSQPBugUnclosedQuote = 'Citare neоnchisa';
$strSQPBugUnknownPunctuation = 'Оnsiruire de punctuatie necunoscuta';
...
$strTextAreaLength = 'Datorita lungimii sale, <br /> acest cоmp s-ar putea sa nu fie editabil';
$strThai = 'Tailandez';
...
$strTransformation_text_plain__substr = 'Afiseaza doar o parte a firului de executie. Prima optiune este un offset pentru definirea punctului de оnceput a outputului de text (Default 0). A doua optiune este un offset de text returnat. Daca este gol, returneaza textul ramas. A treia optiune defineste caracterele care vor fi atasate la output la returnarea unui substring  (Default: ...) .';
...
$strUpdateQuery = 'Reоnnoire comanda';
...
$strUploadErrorExtension = 'Оncarcarea fisierului a fost оmpiedicata de extensie.';
$strUploadErrorNoTempDir = 'Lipseste un dosar temporar.';
$strUploadErrorPartial = 'Fisierul a fost оncarcat numai partial.';
$strUploadErrorUnknown = 'Eroare necunoscuta la оncarcarea fisierului.';
$strUsage = 'Utilizare';
...
$strUserNotFound = 'Utilizatorul selectat nu a fost gasit оn tabelul de drepturi.';
...
$strUser = 'Utilizator';
$strUseTabKey = 'Folositi tasta TAB pentru a trece de la o valoare la alta sau CTRL+sageti pentru a merge оn oricare directie';
$strUseTables = 'Utilizare tabele';
$strUseTextField = 'Utilizare cоmp text';
$strUseThisValue = 'Foloseste aceasta valoare';

$strValidateSQL = 'Valideaza SQL';
$strValidatorError = 'Validatorul SQL nu poate fi initializat. Verificati daca e instalata extesnsia necesara PHP, asa cum e descris оn %sdocumentation%s.';
$strValue = 'Valoare';
$strVar = 'Variabil';
...
$strWebServerUploadDirectory = 'director de оncarcare al serverului Web';
$strWebServerUploadDirectoryError = 'Directorul stabilit pentru оncarcare nu poate fi gasit';
