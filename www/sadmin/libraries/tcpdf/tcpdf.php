	...
	class TCPDF {
		...
		*/
		function _puttruetypeunicode($font) {
			// Type0 Font
			// A composite fontвЂ”a font composed of other fonts, organized hierarchically
			$this->_newobj();
			$this->_out('<</Type /Font');
			...
			// Font descriptor
			// A font descriptor describing the CIDFontвЂ™s default metrics other than its glyph widths
			$this->_newobj();
